<div class="hide-this">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="dataTable_wrapper width100">
                        <table class="table table-hover display nowrap table-bordered width100 text-break" id="service-order-list">
                            <thead>
                                <tr>
    ...
    <div class="width100 section-to-print hidden" id="service-order-form">
        <table border="0">
            <tr>
            ...
            <tr>
                ...
                <td class="text-left"><span>TSG Reference Number:</span>&nbsp;<span class="underline-bottom" style="width: 180px; display: inline-block"></span></td>
            </tr>
            <tr>
            ...
            <!-- <tr>
                ...
                <td style="border-left: 1px solid #000;">
                    ...
                    <span>
                        <label class="radio-inline">
                            <input type="radio" value="1" name="if_under_warranty"> Yes
                        </label>
                        <label class="radio-inline">
                            <input type="radio" value="0" name="if_under_warranty"> No
                        </label>
                    </span>
                </td>
            </tr> -->
